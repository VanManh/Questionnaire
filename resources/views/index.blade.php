                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs btn-group">
                                                ...
                                                <button onclick="window.location.href='/edit-survey/{{$survey->id}}'"
                                                        class="btn btn-xs btn-info">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </button>

                                                <a  href="/delete-survey/{{$survey->id}}" onclick="return acceptanceDelete('Will you accept to delete this Survey')"
